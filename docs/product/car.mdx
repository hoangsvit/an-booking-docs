...
Xem video hướng dẫn đăng bài (*cách đăng tương tự*), **lưu ý chọn đúng loại là `Xe dịch vụ`**. Vui lòng xem hướng dẫn chi tiết bằng hình ảnh ở mục bên dưới.
...
### 1. Tùy chọn loại sản phẩm & danh mục
    ...
    :::danger[Lưu ý!]
    <Tabs>
    <TabItem value="Loại sản phẩm" label="Loại sản phẩm">Product Format phải chọn là `Xe dịch vụ`.</TabItem>
